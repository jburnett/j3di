...
cover: build
	dotnet test --no-build Test.J3DI.Domain/Test.J3DI.Domain.csproj  --framework net10.0 --logger:trx --results-directory ../TestResults \
		"/p:Exclude=\"[Test.J3DI.*]*\"" \
 		"/p:ExcludeByAttribute=\"TestSDKAutoGeneratedCode,AutoGeneratedCode\"" \
 		"/p:CollectCoverage=true" \
		"/p:CoverletOutput=../TestResults/" \
		"/p:MergeWith=../TestResults/coverage.net10.0.json" \
		"/p:CoverletOutputFormat=\"json\"" 
	dotnet test --no-build Test.J3DI.Infrastructure.EntityFactoryFx/Test.J3DI.Infrastructure.EntityFactoryFx.csproj  --framework net10.0 --logger:trx --results-directory ../TestResults \
		"/p:Exclude=\"[Test.J3DI.*]*\"" \
 		"/p:ExcludeByAttribute=\"TestSDKAutoGeneratedCode,AutoGeneratedCode\"" \
		"/p:CollectCoverage=true" \
		"/p:CoverletOutput=../TestResults/" \
		"/p:MergeWith=../TestResults/coverage.net10.0.json" \
		"/p:CoverletOutputFormat=\"json\"" 
	dotnet test --no-build Test.J3DI.Infrastructure.RepositoryFx/Test.J3DI.Infrastructure.RepositoryFx.csproj  --framework net10.0 --logger:trx --results-directory ../TestResults \
		"/p:Exclude=\"[Test.J3DI.*]*\"" \
 		"/p:ExcludeByAttribute=\"TestSDKAutoGeneratedCode,AutoGeneratedCode\"" \
		"/p:CollectCoverage=true" \
		"/p:CoverletOutput=../TestResults/" \
...
cover-report:
	reportgenerator \
		-targetdir:coveragereport/net10.0 \
		"-reports:./TestResults/coverage.net10.0.cobertura.xml"


coveralls-report:
	coveralls report --format=cobertura TestResults/coverage.net10.0.cobertura.xml --repo-token=XK3p5o0AoS4H838oiS9bvVwz4ibcLIkvp
